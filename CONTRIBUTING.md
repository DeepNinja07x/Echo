...
-  Fork this [repository](https://github.com/DeepNinja07x/Echo)
  
-  Clone the forked https://github.com/<Your_Username>/Echo
...
- Add the upstream (main project's) repo's URL
    ...
    > git remote add upstream https://github.com/DeepNinja07x/Echo.git
